...
func smbWalkDir(ctx context.Context, share *smb2.Share, root string,
	excludedDirs dirExclusions, maxDepth int, maxFilesPerDir int, debug bool, dirCount, skippedDirs *int64, fn func(path string, size int64) error) error {
...
func smbWalkDirRecursive(ctx context.Context, share *smb2.Share, dir string,
	excludedDirs dirExclusions, maxDepth int, maxFilesPerDir int, currentDepth int, debug bool, dirCount, skippedDirs *int64, fn func(path string, size int64) error) error {
